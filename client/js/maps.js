            ...
            /*{
                ...
                "items": [
                    ...
                    // Two damaged enemy scout-tanks patroling the area
                    {
                        ...
                        "uid": -2,
                        "life": 20,
                        "orders": {"type": "stand", "from": {"x": 34, "y": 20}, "to": {"x": 42, "y": 25}}
                    },
                    {
                        "type": "vehicles",
                        "name": "scout-tank",
                ...
                "triggers": [
                    ...
                    },
                    {
                        "type": "conditional",
                        "condition": function () {
                            return (common.isItemDead(-1) || common.isItemDead(-3) || common.isItemDead(-4));
                        },
                        "action": function () {
                        ...
                        "action":function(){
                            if(game.cash["green"]>1000){
                                game.sendCommand([-12,-13],{type:"construct-unit", details:{type:"vehicles",
                                    name:"scout-tank", oders:{"type":"hunt"}}});
                            }
                        }
                    },
