(function() {
    ...
    var singleplayer = {
        ...
        startCurrentLevel: function() {
            ...
            // Don't allow player to enter mission until all assets for the level are l
            ...
            for (var type in level.requirements) {
                ...
                for (var i = 0; i < requirementArray.length; i++) {
                    ...
                    if (entities.hasOwnProperty(type)) {
                        if (entities[type].load) {
                            entities[type].load(name);
                        }
                        else {
        ...
        endLevel: function(success) {
            ...
            if (success) {
                ...
                if (moreLevels) {
                    game.messageBox.showMessageBox("Mission Accomplished.",
                        function() {
                            $('.gamelayer').hide();
                    ...
                    game.messageBox.showMessageBox("Mission Accomplished.<br><br>This was the last mission in the campaign.<br><br>Thank You for playing.",
                        function() {
                            $('.gamelayer').hide();
                            $('#gamestartscreen').show();
                        });
                ...
                game.messageBox.showMessageBox("Mission Failed.<br><br>Try again?", function() {
                    $('.gamelayer').hide();
                    singleplayer.startCurrentLevel();
                }, function() {
                    $('.gamelayer').hide();
    ...
    namespace.singleplayer = singleplayer;
}());